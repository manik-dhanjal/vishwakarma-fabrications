...
export const MapPin = ({ size = 22 }: IconProps) => (
  <svg {...base(size)} aria-hidden="true">
...
export const Clock = ({ size = 22 }: IconProps) => (
  <svg {...base(size)} aria-hidden="true">
...
export const Whatsapp = ({ size = 23 }: IconProps) => (
...
export const Instagram = ({ size = 23 }: IconProps) => (
  <svg {...base(size)} aria-hidden="true">
...
export const Facebook = ({ size = 23 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
